...
export const getCicsRegionStatusTool = defineTool({
    name: 'get_cics_region_status',
    description: 'Get the current status, version, and attributes of a CICS region via CMCI.',
    input: inputShape,
    async run({ region, context }, ctx) {
